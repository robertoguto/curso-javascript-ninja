...
// eu crio essa função IIFE para proteger as funçoes que estão dentro dela
...
*/
let resposta = sum(function (valor1, valor2) {
...
let subtraction = sum(function (valor1, valor2) {
    return valor1 - valor2;
});
let multiplication = sum(function (valor1, valor2) {
    return valor1 * valor2;
});
let division = sum(function (valor1, valor2) {
    return valor1 / valor2;
});
let mod = sum(function (valor1, valor2) {
    return valor1 % valor2;
});
